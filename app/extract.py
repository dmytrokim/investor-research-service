EXTRACTION_SYSTEM_PROMPT = """You extract verified facts about ONE SPECIFIC TARGET INVESTOR from the text of ONE web page that was already fetched for you. You have NO web access.
...
18. Output ONLY valid JSON matching this shape, no prose, no markdown fences:

{"dimension": "...", "found": true/false, "facts": [{"field": "...", "value": "...", "source_url": "...", "confidence": "high"|"medium"|"low"}], "notes": "..."}
"""
...
10. Output ONLY valid JSON matching this exact shape, no prose, no markdown fences, for fit_score use ONLY PRESENTED VALUES: {"thesis_fit": "...", "fit_score": "strong"|"possible"|"weak"|"no_fit", "top_angles": ["...", "..."], "likely_objections": ["...", "..."], "red_flags": ["...", "..."], "recommended_next_step": "..."}
"""
...
def call_extraction(client, page) -> DimensionResult:
